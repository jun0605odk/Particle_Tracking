...
if (size(varargin{2},2)==2) & (size(varargin{1},2)==17)
    ...
    handles.unit_time = varargin{1}(15);
    handles.unit_length = varargin{1}(16);
    handles.display = varargin{1}(17);
    handles.save = 0;
...
handles.display = pt_GUIDE_select_fig(handles.display);
guidata(hObject,handles);
...
handles.ts = str2double('0');
handles.te = str2double('35');
handles.display = str2double('101111111');
handles.unit_time = str2double('1');
handles.unit_length = str2double('64.5');
